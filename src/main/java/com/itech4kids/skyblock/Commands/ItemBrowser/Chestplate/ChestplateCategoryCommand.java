package com.itech4kids.skyblock.Commands.ItemBrowser.Chestplate;
...
public class ChestplateCategoryCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String s, String[] args) {
        ...
        skyblockPlayer.setInventory("Chestplates", Bukkit.createInventory(null, 54, "Chestplates"));
        Inventory menu = skyblockPlayer.getInventory("Chestplates");
        ...
        // Add items to menu
        menu.setItem(10, ItemHandler.superior_dragon_chestplate);
        menu.setItem(11, ItemHandler.farm_suit_chestplate);
        menu.setItem(11, ItemHandler.mushroom_chestplate);
        ...
        player.openInventory(skyblockPlayer.getInventory("Chestplates"));
