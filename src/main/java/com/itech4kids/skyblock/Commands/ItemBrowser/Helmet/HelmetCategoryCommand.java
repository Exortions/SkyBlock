package com.itech4kids.skyblock.Commands.ItemBrowser.Helmet;
...
public class HelmetCategoryCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String s, String[] args) {
        ...
        skyblockPlayer.setInventory("Helmets", Bukkit.createInventory(null, 54, "Helmets"));
        Inventory menu = skyblockPlayer.getInventory("Helmets");
        ...
        // Add items to menu
        menu.setItem(10, ItemHandler.superior_dragon_helmet);
        menu.setItem(11, ItemHandler.farm_suit_helmet);
        menu.setItem(11, ItemHandler.mushroom_helmet);
        ...
        player.openInventory(skyblockPlayer.getInventory("Helmets"));
